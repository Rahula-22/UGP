        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm lg:col-span-2">
          ...
          {tryOnResult && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-stone-300 px-4 py-2.5 text-xs font-bold text-stone-700 transition-all hover:border-rose-400 hover:bg-rose-50"
            >
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-stone-300 bg-white px-4 py-2.5 text-sm font-bold text-stone-800 transition-all hover:border-rose-400 hover:bg-rose-50"
              >
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-600 to-amber-500 px-4 py-3 text-sm font-bold text-white shadow transition-all hover:-translate-y-0.5 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-60"
            >
              {tryingOn ? (
